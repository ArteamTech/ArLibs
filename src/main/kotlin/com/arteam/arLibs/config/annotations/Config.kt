 ...
 *                 配置文件的名称（不包括扩展名）
 * @param filePath Optional relative path within the plugin's data folder (e.g., "modules/settings")
 *                 可选的相对路径，位于插件数据文件夹内（例如，"modules/settings"）
 * @param comments Optional comments to include at the top of the configuration file
 *                 可选的注释，将包含在配置文件的顶部
 *
 * @author ArteamTech
 * @since 2025-05-18
